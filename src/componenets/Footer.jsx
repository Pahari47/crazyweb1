        ...
        <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading">
                    <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-15'>Eye-</h1>
                    <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-15'>Opening</h1>
                </div>
            ...
            <div className="w-1/2">
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-15'>Presentations</h1>
            <div className="dets">
                <p className='block text-xl font-light mt-10 mb-10'>s:</p>
